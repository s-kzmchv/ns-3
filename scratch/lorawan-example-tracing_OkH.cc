...
#include <ns3/okumura-hata-propagation-loss-model.h> //подключение Okumara Hate Model
...
LoRaWANExampleTracing::CalculateDataRateIndexPER (Ptr<Application> endDeviceApp)
{
  ...
  Ptr<PropagationLossModel> lossModel = CreateObject<OkumuraHataPropagationLossModel> (); // создание объекта с Okuura Hata Model 28.04.18
  ...
  lossModel ->SetAttribute ("Frequency", DoubleValue (freq));//задание частоты для модели распростронения 
