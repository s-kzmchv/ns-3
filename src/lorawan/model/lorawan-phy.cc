...
//            std::cout << "DROP SINR_TOO_LOW " <<  " SF:" << LoRaWAN::m_supportedDataRates [m_currentDataRateIndex].spreadingFactor << ";" << " DataRate:"  << (int)m_currentDataRateIndex  << std::endl;
...
//        std::cout << "DROP PHY_BUSY_RX " <<  " SF:" << LoRaWAN::m_supportedDataRates [m_currentDataRateIndex].spreadingFactor << ";" << " DataRate:"  << (int)m_currentDataRateIndex  << std::endl;
...
//              std::cout << "DROP PACKET_DESTROYED " <<  " SF:" << LoRaWAN::m_supportedDataRates [m_currentDataRateIndex].spreadingFactor << ";" << " DataRate:"  << (int)m_currentDataRateIndex  << std::endl;
...
//  std::cout << sf << std::endl;
  ...
  uint16_t nConditionalSymbolsPayload = ceil((8.0*payloadLength - 4.0*sf + 28 + 16*crc)/4.0/((double)sf - DE))*(m_codeRate + 4);
